...
echo "🤖 Manual AI Manager Summarization Test\n";
echo "=====================================\n\n";
...
echo "🔄 Sending to AI Manager for summarization...\n";
...
try {
    ...
    echo "📤 Requesting summarization from AI Manager...\n";
